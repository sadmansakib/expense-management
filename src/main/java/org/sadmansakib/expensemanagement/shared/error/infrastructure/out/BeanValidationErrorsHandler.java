package org.sadmansakib.expensemanagement.shared.error.infrastructure.out;
...
public class BeanValidationErrorsHandler {
    ...
    private Map<String, String> buildErrors(MethodArgumentNotValidException exception) {
        return exception
                ...
                .getFieldErrors()
                .stream()
                .collect(Collectors.toUnmodifiableMap(FieldError::getField,
    ...
    ProblemDetail handleExpenseManagementException(ExpenseManagementException exception) {
